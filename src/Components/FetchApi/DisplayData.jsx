  ...
  return (
    <div className="container my-5">
      <Container fluid>
        <Row>
          {infos.map((ele, idx) => (
            <Col lg={2} md={4} sm={6} xs={12} key={ele.work.cover_id}>
              <Card
                style={{
                  minHeight: "590px",
                  width: "200px",
              ...
              >
                ...
                <Card.Body>
                  <Card.Title className="fw-bold mb-4">{ele.work.title}</Card.Title>
                  <Card.Text
                    className="authorName"
                    onClick={() => {
                      handleAuthor(ele.work.author_names[0]);
                    }}
                  >
                    By : {ele.work.author_names[0]}
                  </Card.Text>
                  <Card.Text>  On: {ele.work.first_publish_year}</Card.Text>
